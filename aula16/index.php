<?php
  ...
  //include: não interrompe a execução
  //require: interrompe
  //_once: uma vez
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="carousel-item active">
      <img src="imagens/cafe1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imagens/cafe5.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imagens/cafe2.jpeg" class="d-block w-100" alt="...">
    </div>
    </div>
